...
public class Main {
	...
	public static int[] diverser = {3,1,2,3,6};
	public static String ab = "ababababa";
...

	{
		...
		System.out.println("shifted is" + shiftright(reverse, 10, 2));
		System.out.println(returnpeakindex(fengzhi));
		System.out.println(nondiverser(diverser));
	...
	public static int mystonewall(int[] A) {
		...
		System.out.println("blocks are" + my.toString() + ","
				+ small.toString());
	...
	public static String shiftright(String s, int length, int nr) {

		String a = reverse(s, 0, nr - 1);
		String b = reverse(a, nr, length - 1);
		String c = reverse(b, 0, length - 1);

		return c;
	}

	public static int[] returnpeakindex(int[] A) {
	...
	public static int[] nondiverser(int[] A){
